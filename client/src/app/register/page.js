...
import { Mail, Lock, User, ShieldAlert, Plane } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-card border border-card-border rounded-3xl shadow-xl overflow-hidden glass p-8">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-slate-400 text-sm mt-1">
            Sign up to book flights and track trip weather conditions.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-card-border rounded-2xl focus:bg-white text-sm"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-brand-primary hover:bg-brand-primary-hover text-white text-sm font-semibold rounded-2xl shadow-lg shadow-brand-primary/15 transition-all hover:scale-[1.01] disabled:opacity-50 disabled:scale-100 mt-4"
          >
